...
const MeForYou = () => {
  return (
    <>
      <div className="p-5 -mt-10 md:mt-0 flex items-center justify-center   font-poly">
        <div className="bg-gray-700 opacity-85 w-full md:w-10/12 rounded-xl sm:mt-0 mt-16 text-white">
